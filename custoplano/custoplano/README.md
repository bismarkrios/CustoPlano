...
1. **Cronograma de obra → Importar cronograma** e escolha o seu `.mpp`. A EAP, as datas, a linha de base e o campo de peso vêm do arquivo.
...
- As telas Orçamento de obra, Macrocronograma, Linha de balanço, Curto prazo, Suprimentos e Restrições ainda usam dados de exemplo; o cronograma real e as medições (tela Cronograma de obra) já são gravados no banco.
